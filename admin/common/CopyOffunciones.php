...
function cargaSesiones()
{
   ...
   $rowDatosLogin = mysql_fetch_object($DatosLogin);
...
function piePagina()
{
echo '<div id="footer">be-Web / Etereus CMS';
echo '<div align="center">Poductos inform&aacute;ticos - Desarrollo web - Asesor&iacute;as</div>';
echo '<div align="center">';
echo '<div align="center"><a href="mailto:jccn1812@gmail.com">Correo electr&oacute;nico:jccn1812@gmail.com</a></div> </div>';
...
function chequeaPerfil($argPerfil){
	   try {
			...
			if (mysqli_connect_errno()) {
                ...
                echo "call sp_EtereusCMS_select_ObtienePerfilPorNombrePerfil(". $_SESSION["IDUSUARIO"].",'".$argPerfil."')";
...
function muestraFechaDDMMAAAA($lafecha){
  	...
  	list( $anio, $mes, $dia ) = split( '[__-]', $lafecha);
    return "$dia-$mes-$anio";
...
function muestraFechaAAAAMMDD($lafecha){
  	...
  	list( $dia,$mes,$anio,  ) = split( '[__-]', $lafecha);
    return "$anio-$mes-$dia";
